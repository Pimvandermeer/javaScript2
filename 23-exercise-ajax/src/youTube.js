export var youtube = {
  ...
  generateThumbnailUrl: function(videoIdOrUrl) {
    return (
      ...
      youtube.getIdFromUrl(videoIdOrUrl) +
      "/default.jpg"
    );
  },
  ...
  generateWatchUrl: function(videoIdOrUrl) {
    return (
      "https://www.youtube.com/watch?v=" + youtube.getIdFromUrl(videoIdOrUrl)
    );
  },
  ...
  generateEmbedUrl: function(videoIdOrUrl) {
    return (
      "https://www.youtube.com/embed/" + youtube.getIdFromUrl(videoIdOrUrl)
    );
  }
};
